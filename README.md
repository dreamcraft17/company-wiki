...
- [Product Docs Index](./docs/products/README.md) — product folders under `docs/products/`
  ...
  - [dnPeople HRIS](./docs/products/dnPeople/README.md) — [hris.dntech.id](https://hris.dntech.id) · **v1.1.0** · legal v1.1 + assistant v17 + DOKU payment gateway + evidence timeline · next **PRD v16.0**
...
*Last Updated: September 17, 2026 · Founded by Dozer Napitupulu · Leadership: CEO + Tech Lead + PM (Dozer)*
