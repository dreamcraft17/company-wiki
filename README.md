...
- [Product Docs Index](./docs/products/README.md) — product folders under `docs/products/`
  ...
  - [dnPeople HRIS](./docs/products/dnPeople/README.md) — [hris.dntech.id](https://hris.dntech.id) · **v1.1.2** · HEAD `55ec9ae` · DOKU + `/admin/health` + plan catalog/trials + legal v1.2 + assistant v17 Professional+ · next **PRD v16.0**
...
*Last Updated: September 25, 2026 · Founded by Dozer Napitupulu · Leadership: CEO + Tech Lead + PM (Dozer)*
