...
| **DOVA** | [dova/](./dova/00_INDEX.md) | Full docs + PRD/SRS/SDD + **All-features** (101) + QA/release audit | **v0.5.4** · **production live** · HEAD `9e37a8a` · [dova.dntech.id](https://dova.dntech.id) | `dova` + **`dova-comp-wiki`** |
