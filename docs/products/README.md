...
| **dnCore (ERP)** | [dnpeople-erp/](./dnpeople-erp/00_INDEX.md) | PRD/SDD/SRS + baselines | dnCore v1.0 + Phase 5 hardening (`2aaf9f9`) · 397 tests / 85 suites | `ERP` |
...
|---------|--------|-----------|
| **dnCore (ERP)** | `2aaf9f9` | Phase 5 hardening — Stripe payment retry, digest email, k6 authenticated, security acceptance, Cypress role UAT — **397** tests / **85** suites |
